...
DOCUMENTATION = r"""
---
module: ai_inference_chat_meta_llama_3_3_70b_instruct
short_description: stateless interface for meta/llama-3.3-70b-instruct
description:
    - Provides a stateless interface for meta/llama-3.3-70b-instruct.
...
- name: One-shot prompt
  ai_inference_chat_meta_llama_3_3_70b_instruct:
