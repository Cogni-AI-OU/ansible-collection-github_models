...
DOCUMENTATION = r"""
---
module: ai_inference_chat_openai_gpt_4o_mini
short_description: stateless interface for openai/gpt-4o-mini
description:
    - Provides a stateless interface for openai/gpt-4o-mini.
...
- name: One-shot prompt
  ai_inference_chat_openai_gpt_4o_mini:
