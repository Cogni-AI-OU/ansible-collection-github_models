...
DOCUMENTATION = r"""
---
module: ai_inference_chat_xai_grok_3
short_description: stateless interface for xai/grok-3
description:
    - Provides a stateless interface for xai/grok-3.
